...
TEST_CASE("Verify get letter grade using if else.", "See if returns proper letter grade.") 
{
...
TEST_CASE("Verify get letter grade using switch function.", "See if function returns the proper grade.") 
{
