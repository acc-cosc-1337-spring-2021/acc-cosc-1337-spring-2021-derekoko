...
TEST_CASE("Test get generation", "Enter year return generation string") 
{
	...
	REQUIRE(get_generation(1975) == "Gen X");
...
TEST_CASE("Test number is NOT in range 1 to 10", "Given number return true if NOT in range") 
{
...
TEST_CASE("Test number is NOT in range 1 to 10 using OR", "Given number return true if NOT in range using OR") 
{
